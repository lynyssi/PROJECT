...
<p>
	...
	<div>
		<a href="<c:url value='/AdminNoticeMod.do?bIdx=${bv.bIdx}'/>"><button class="btn btn-primary pull-right">수정</button></a>
	</div>
	<div>
		<a href="<c:url value='/AdminNoticeList.do'/>"><button class="btn btn-primary pull-right">목록</button></a>
	</div>	
