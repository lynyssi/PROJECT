...
import com.mirin.tech.service.CMemberServiceImpl;
...
*/
	...
	@RequestMapping(value = "/CMemberMemoWrite.do")
	public String CMemberMemoWrite(HttpServletRequest request, HttpServletResponse response) {
		...
		mlist = ci.cMemberMemoWriteIMemberList(sess_idx);
		
		request.setAttribute("mlist", mlist);
		
		return "cmember/CMemberMemoWirte";
	}
	
	@RequestMapping(value = "/CMemberMemoSendList.do")
	public String CMemberMemoSendList(ModelMap modelMap, HttpServletRequest request) {
		...
		ArrayList<Map<String, Object>> dataList = new ArrayList<Map<String, Object>>();
		dataList = ci.cMemberMemoSendList(sess_idx);
		
		modelMap.addAttribute("dataList", dataList);
	
		return "cmember/CMemberMemoSendList";
	}
	
	@RequestMapping(value = "/CMemberMemoCon.do")
	public String CMemberMemoCon(ModelMap modelmap, HttpServletRequest request) {
		...
		Map<String, Object> data = new HashMap<String, Object>();
		data = ci.cMemberMemoCon(memoIdx);
		
		modelmap.addAttribute("data", data);
		System.out.println(data);
		return "cmember/CMemberMemoCon";
	}
	
	@RequestMapping(value = "/CMemberMemoDel_Action.do")
	public String CMemberMemoDel_Action(HttpServletRequest request, HttpServletResponse response) {
		...
		int row = 0;
		row = ci.cMemberMemoDel(memoIdx);
		
		return "redirect:/CMemberMemoSendList.do";
	}
	
	@RequestMapping(value = "/CMemberNewsList.do")
	public String CMemberNewsList(ModelMap modelMap, HttpServletRequest request) {
		...
		ArrayList<BoardVo> blist = new ArrayList<BoardVo>();
		blist = ci.cMemberNewsList(sess_idx);
		
		modelMap.addAttribute("blist", blist);
		
		return "cmember/CMemberNewsList";
	}
	
	@RequestMapping(value = "/CMemberNewsCon.do")
	public String CMemberNewsCon(ModelMap modelMap, HttpServletRequest request) {
		...
		Map<String, Object> data = new HashMap<String, Object>();
		data = ci.cMemberNewsCon(bIdx);

		modelMap.addAttribute("data", data);
		
		return "cmember/CMemberNewsCon";
	}

	@RequestMapping(value = "/CMemberNewsMod.do")
	public String CMemberNewsMod(ModelMap modelMap, HttpServletRequest request) {
		...
		return "cmember/CMemberNewsMod";
	}
	
	@RequestMapping(value = "/CMemberNewsMod_Action.do")
	public String CMemberNewsMod_Action(HttpServletRequest request, HttpServletResponse response) {
		...
		int row = 0;
		row = ci.cMemberNewsMod(bv);

		return "redirect:/CMemberNewsCon.do?bIdx="+bIdx+"";
	}
	
	@RequestMapping(value = "/CMemberNewsWrite.do")
	public String CMemberNewsWrite(ModelMap modelMap, HttpServletRequest request) {
		...
		pv = ci.cMemberNewsWriteProjNow(sess_idx);
		
		modelMap.addAttribute("pv", pv);
				
		return "cmember/CMemberNewsWrite";
	}
	

	@RequestMapping(value = "/CMemberNewsWrite_Action.do")
	public String CMemberNewsWrite_Action(HttpServletRequest request, HttpServletResponse response) {
		...
		int row = 0;
		row = ci.cMemberNewsWrite(bv);
		
		return "redirect:/CMemberNewsList.do";
	}
	
	@RequestMapping(value = "/CMemberNewsDel_Action.do")
	public String CMemberNewsDel_Action(HttpServletRequest request, HttpServletResponse response) {
